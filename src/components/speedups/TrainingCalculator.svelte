...
<style>
    ...
    .fade-in-panel { animation: fadeIn 0.3s ease-out; }
    ...
    .info-btn { background: none; border: none; color: var(--text-secondary); font-size: 1.1rem; cursor: pointer; padding: 4px; transition: color 0.2s; }
    .info-btn:hover { color: var(--accent-blue); }
    .tooltip-container { position: absolute; right: 0; top: 100%; margin-top: 10px; background: var(--bg-tertiary); border: 1px solid var(--border-color); padding: 15px; border-radius: var(--radius-md); width: 300px; z-index: 200; box-shadow: 0 4px 20px rgba(0,0,0,0.6); }
    ...
    .troop-grid.upgrade-group::after { background: linear-gradient(135deg, #ca62e6 0%, #8113a7 45%, #f28d00 55%, #d55800 100%); opacity: 0.25; }
    ...
    .troop-item label { font-size: 0.75rem; margin: 0; font-weight: 500; color: var(--text-secondary); }
    .troop-item img { width: 32px; height: 32px; object-fit: contain; }
    .troop-item input { width: 100%; text-align: center; padding: 4px; font-size: 1rem; border: 1px solid var(--border-color); background: var(--bg-primary); border-radius: var(--radius-sm); color: white; }
