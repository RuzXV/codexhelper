            ...
            <div class="section-card" class:collapsed={!reminder.is_active}>
                <div class="section-header">
                    <div class="header-title">
                        <h3>
                            <i class="fas {reminder.reminder_type === 'ruins' ? 'fa-monument' : 'fa-place-of-worship'}"
                            ></i>
                        ...
                        {#if (!reminder.role_id || !reminder.role_menu_message_id) && !reminder._placeholder}
                            <div class="warning-banner">
                                ...
                                <div class="warning-text">
                                    <strong>Syncing:</strong> The bot is creating roles and the role menu. This may take a
                                    moment.
                                </div>
                            </div>
                        {/if}
                                ...
                                <div class="setting-col">
                                    <div class="setting-group">
                                        ...
                                        <div class="custom-select-container">
                                            <button
                                                ...
                                                on:click={(e) => toggleDropdown(reminder.reminder_type, e)}
                                            >
                                    ...
                                    <div class="shift-controls" style="margin-top: 20px;">
                                        ...
                                        <div class="shift-buttons">
                                            <button class="btn-shift" on:click={() => shiftTime(reminder, -60)}
                                                >-1 Hour</button
                                            >
                                            <button class="btn-shift" on:click={() => shiftTime(reminder, -1)}
                                                >-1 Minute</button
                                            >
                                            <button class="btn-shift" on:click={() => shiftTime(reminder, 1)}
                                                >+1 Minute</button
                        ...
                        {#if setupForms[reminder.reminder_type]}
                            ...
                            <div class="setup-form">
                                <div class="setup-form-header">
                                    ...
                                    <span
                                        >Set up {reminder.reminder_type === 'ruins'
                                            ? 'Ancient Ruins'
                                            : 'Altar of Darkness'} reminders</span
                                    >
                                </div>
                                ...
                                <div class="setup-form-body">
                                        ...
                                        <div class="setup-group">
                                            ...
                                            <div class="custom-select-container">
                                                <button
                                                    ...
                                                    on:click={(e) =>
                                                        toggleDropdown(`setup-ch-${reminder.reminder_type}`, e)}
                                                >
                                        ...
                                        <div class="setup-group">
                                            ...
                                            <div class="datetime-row">
                                                <input
                                                    ...
                                                    on:change={() => (setupForms = setupForms)}
                                                />
                                                <input
                                                    type="time"
                                    ...
                                    <div class="setup-info">
                                        ...
                                        <span
                                            ...
                                            menu in the chosen channel. Events repeat every {reminder.reminder_type ===
                                            'ruins'
                                                ? '40'
                                                : '86'} hours.</span
                                        >
                                    ...
                                    <div class="setup-actions">
                                        <button
                                            ...
                                            on:click={() => cancelSetupForm(reminder.reminder_type)}
                                            disabled={saving}>Cancel</button
                                        >
                                        <button
                                            class="btn-setup-confirm"
                                            on:click={() => submitSetup(reminder.reminder_type)}
                                            disabled={saving}
                                        >
                        ...
                        <div class="custom-card-body">
                                ...
                                <div class="c-group">
                                    ...
                                    <div class="custom-select-container">
                                        <button
                                            type="button"
                                            class="custom-select-trigger small"
                                            on:click={(e) => toggleDropdown(`custom-ch-${i}`, e)}
                                        >
                                ...
                                <div class="c-group">
                                    ...
                                    <div class="custom-select-container">
                                        <button
                                            type="button"
                                            class="custom-select-trigger small"
                                            on:click={(e) => toggleDropdown(`custom-role-${i}`, e)}
                                        >
                                ...
                                <div class="c-group" style="flex: 1;">
                                    ...
                                    <div class="custom-select-container">
                                        <button
                                            type="button"
                                            class="custom-select-trigger small"
                                            on:click={(e) => toggleDropdown(`custom-unit-${i}`, e)}
                                        >
                            ...
                            <div class="custom-row footer-row">
                                ...
                                <div class="shift-buttons mini">
                                    <button class="btn-shift" on:click={() => shiftTime(custom, -60)}
                                        >-1<br />Hour</button
                                    >
                                    <button class="btn-shift" on:click={() => shiftTime(custom, -1)}
                                        >-1<br />Minute</button
                                    >
                                    <button class="btn-shift" on:click={() => shiftTime(custom, 1)}
                                        >+1<br />Minute</button
...
<style>
    ...
    .btn-setup-confirm:hover {
        opacity: 0.9;
    }
    .btn-setup-confirm:disabled,
    .btn-setup-cancel:disabled {
        opacity: 0.5;
        cursor: not-allowed;
    }
