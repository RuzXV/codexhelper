...
<style>
    ...
    .interaction-header { display: flex; align-items: center; font-size: 0.85rem;
        color: #949ba4; margin-bottom: 2px; gap: 5px; position: relative; left: 16px; }
    .interaction-header::before { 
        content: ""; position: absolute; top: 14px; left: -11px;
        width: 24px; height: 12px; border-top: 2px solid #4e5058; border-left: 2px solid #4e5058; 
        border-top-left-radius: 6px; margin-top: -3px; 
    }
    ...
    .embed-wrapper { border-left-style: solid; border-left-width: 4px; background: #2b2d31; border-radius: 4px; padding: 12px 16px; max-width: 520px; display: flex; margin-left: 52px; margin-top: -6px; }
    ...
    .field-name { font-weight: 700; font-size: 0.875rem; color: #f2f3f5; margin-bottom: 4px; }
    .field-name code { background-color: #1e1f22; padding: 2px 4px; border-radius: 3px; font-family: monospace; font-weight: 600; color: #dbdee1; }
    ...
    .component-row { margin-left: 52px; margin-top: 8px; display: flex; gap: 8px; flex-wrap: wrap; }
    .discord-btn { background-color: #43464d; color: #f2f3f5; padding: 4px 16px; border-radius: 3px; font-size: 0.875rem; font-weight: 500; display: flex; align-items: center; gap: 8px; cursor: not-allowed; height: 32px; transition: background-color 0.17s ease; }
    ...
    .lightbox-img { max-width: 90vw; max-height: 90vh; object-fit: contain; border-radius: 4px; box-shadow: 0 0 20px rgba(0,0,0,0.5); }
